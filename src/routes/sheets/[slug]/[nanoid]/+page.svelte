    ...
    <div class="mb-6">
      ...
      <div class="flex items-center justify-between gap-4 mt-2">
        ...
        <button
          ...
          class="share-button px-4 py-2 bg-neutral-900 hover:bg-neutral-800 text-white text-sm font-medium rounded-xl border border-neutral-700 hover:border-neutral-600 transition-all duration-200 flex items-center gap-2 cursor-pointer"
        >
          {#if copySuccess}
