...
<!-- Drawer Content -->
<div
  class="fixed bottom-0 left-0 right-0 bg-neutral-900 rounded-t-3xl z-50 shadow-2xl transform transition-all duration-300 ease-out max-h-[85vh] flex flex-col {isOpen ? 'translate-y-0' : 'translate-y-full pointer-events-none'}"
